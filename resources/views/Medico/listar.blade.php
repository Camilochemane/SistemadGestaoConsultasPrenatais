                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l12">
                    	<div class="card">
                            ...
                            @include('sweet::alert')
                            {!!Form::open(['route'=>'pesquisarMedico', 'method' => 'POST', 'class' => 'col s12'])!!}
                                    @csrf
                                <div class="row">
                                    <div class="input-field col s3">
                                        <p>Lista dos medicos</p>
                                    </div>
                                    ...
                                    <div class="input-field col s9">
                                            ...
                                            @foreach($especialidade as $especialidade)
                                                <option value="{{ $especialidade->id }}">{{ $especialidade->designacao }}</option>
                                            @endforeach
                                        </select>
                                            </div>
                                            <div class="input-field col s4">
                                    ...
                                    @forelse($user as $users)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('detalhesAgenda', $users->id) }}" class="waves-effect waves-light btn green m-b-xs">Detalhes</a>
                                            </td>
                                        </tr>
                                    @empty
                                    	<tr>
